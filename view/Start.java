...
public class Start {
	...
	public void start() {
//		while(true){
//			System.out.println("Inï¿½cio - Jogo da Velha");
			sc = new Scanner(System.in);
//			while(true){
//				System.out.println("Quer comeï¿½ar? Se sim digite: 0. Se nï¿½o digite: 1 ");
//				toStart = sc.nextInt();
...
//			}
//			while(true){
//				System.out.println("Quer ser X ou O? Se X, digite: true. Se nï¿½o digite: false ");
//				toPiece = sc.nextInt();
...
//			}
//			while(true){
//				System.out.println("Escolha o nï¿½vel. Para fï¿½cil, digite 0 , mï¿½dio 1, dï¿½ficil 2.");
//				level = sc.nextInt();
