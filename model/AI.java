...
public class AI {
	...
	/*public int[][] bestMove(int[][] board){
		...
		if (row1==bigger){
			if(board[ROW_1][COLUMN_1] == EMPTY){
				board[ROW_1][COLUMN_1]=PC;// 1 � a jogado do PC
				return board;
			}
	...
	public static void print(){//DEBUG
	...
	public void updateScore(int[][] board){
		...
		if (board[ROW_2][COLUMN_2] == EMPTY) center = 12;
		if (board[ROW_1][COLUMN_1] == EMPTY) corner = 11;
		if (board[ROW_3][COLUMN_3] == EMPTY) corner = 11;
		if (board[ROW_1][COLUMN_3] == EMPTY) corner = 11;
		if (board[ROW_3][COLUMN_1] == EMPTY) corner = 11;
		...
		if (board[ROW_1][COLUMN_1] == HUMAN & board[ROW_2][COLUMN_2] == HUMAN & board[ROW_3][COLUMN_3] == PC) row1 = 13;
		if (board[ROW_3][COLUMN_1] == PC & board[ROW_2][COLUMN_2] == HUMAN & board[ROW_1][COLUMN_3] == HUMAN) row1 = 13;// proteger contra fork
		...
		if(board[ROW_1][COLUMN_1] == HUMAN & board[ROW_2][COLUMN_2] == PC & board[ROW_3][COLUMN_3] == HUMAN & board[ROW_2][COLUMN_1] == EMPTY & board[ROW_2][COLUMN_3] == EMPTY) row2 = 15;// evitar fork
		...
		if (board[ROW_1][COLUMN_1] == PC & board[ROW_2][COLUMN_2] == HUMAN & board[ROW_3][COLUMN_3] == HUMAN) row3 = 13;// proteger contra for
		if (board[ROW_3][COLUMN_1] == HUMAN & board[ROW_2][COLUMN_2] == HUMAN & board[ROW_1][COLUMN_3] == PC) row3 = 13;
		...
		if (board[ROW_1][COLUMN_1] == HUMAN & board[ROW_2][COLUMN_2] == HUMAN & board[ROW_3][COLUMN_3] == PC) column1 = 13;// proteger contra fork
		if (board[ROW_3][COLUMN_1] == HUMAN & board[ROW_2][COLUMN_2] == HUMAN & board[ROW_1][COLUMN_3] == PC) column1 = 13;
		...
		if(board[ROW_3][COLUMN_1] == HUMAN & board[ROW_2][COLUMN_2] == PC & board[ROW_1][COLUMN_3] == HUMAN & board[ROW_1][COLUMN_2] == EMPTY & board[ROW_3][COLUMN_2] == EMPTY) column2 = 15;// evitar fork
		...
		if (board[ROW_3][COLUMN_1] == PC & board[ROW_2][COLUMN_2] == HUMAN & board[ROW_1][COLUMN_3] == HUMAN) column3 = 13;
		if (board[ROW_1][COLUMN_1] == PC & board[ROW_2][COLUMN_2] == HUMAN & board[ROW_3][COLUMN_3] == HUMAN) column3 = 13;// proteger contra fork
